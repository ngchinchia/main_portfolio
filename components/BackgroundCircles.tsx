...
export default function BackgroundCircles({}: Props) {
  return (
    ...
    >
      ...
      <div className="absolute border border-[#64CCC5] rounded-full lg:h-[650px] lg:w-[650px] sm:h-[325px] sm:w-[325px] mt-52 animate-pulse opacity-20" />
      <div className="absolute border border-[#64CCC5] rounded-full lg:h-[800px] lg:w-[800px] sm:h-[400px] sm:w-[400px] mt-52 animate-pulse opacity-20" />
    </motion.div>
  );
}
