...
export default function Projects({}: Props) {
  ...
  return (
    <div className="h-screen flex flex-col text-center max-w-7xl px-10 justify-center py-20 mx-auto items-center">
      ...
      <div
        className="w-full flex overflow-x-scroll scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#64CCC5]/90 md:overflow-y-scroll xl:overflow-y-scroll sm:overflow-y-scroll snap-x snap-mandatory "
        id="scrollContainer"
      >
        <Project
